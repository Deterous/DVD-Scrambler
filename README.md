...
The C++ code shows an example implementation, which is easier to understand than my explanation. This research was done for [redumper](https://github.com/superg/redumper/) which is now capable of dumping & descrambling Nintendo (GameCube and Wii) discs on compatible drives (e.g. [OmniDrive](https://github.com/RibShark/OmniDrive)).
